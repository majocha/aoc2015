...
let inMemory = input |> List.sumBy String.length

let literals = System.IO.File.ReadAllLines "8.txt" |> Seq.sumBy String.length

literals - inMemory

let literalsA = System.IO.File.ReadAllLines "8.txt"

#r "nuget: Microsoft.CodeAnalysis.CSharp, 4.4.0"

let escape (s: string) = Microsoft.CodeAnalysis.CSharp.SymbolDisplay.FormatLiteral(s, true)

let literalsEscaped = literalsA |> Seq.map escape |> Seq.sumBy String.length

literalsEscaped - literals
